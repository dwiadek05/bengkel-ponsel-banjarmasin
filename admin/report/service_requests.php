...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Laporan Service</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Laporan Service</b></h3>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $i = 1;
                        ...
                        $qry = $conn->query("SELECT s.*,CONCAT(c.firstname,' ',c.middlename,' ',c.lastname) as fullname from service_requests s inner join client_list c on s.client_id = c.id {$where} order by unix_timestamp(s.date_created) desc");
